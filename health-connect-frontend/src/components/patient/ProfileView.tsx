  ...
  <div className="max-w-4xl mx-auto space-y-6">
    ...
    <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
      ...
      <div className="px-8 py-8 border-b border-slate-100 flex flex-col sm:flex-row items-center sm:items-start gap-6 bg-slate-50/50">
        <div className="w-24 h-24 rounded-full bg-blue-100 flex items-center justify-center border-4 border-white shadow-md text-blue-700 font-bold text-3xl">
      ...
      <div className="p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-sm font-bold text-slate-400 uppercase tracking-wider mb-4 border-b border-slate-100 pb-2">Contact Information</h4>
          ...
          {/* Medical Info */}
          <div>
            <h4 className="text-sm font-bold text-slate-400 uppercase tracking-wider mb-4 border-b border-slate-100 pb-2">Medical Profile</h4>
            <div className="space-y-4 text-sm">
              <div>
                <p className="text-slate-500 mb-1.5">Known Allergies</p>
                <div className="flex flex-wrap gap-2">
                  {mockProfile.allergies.map((allergy, idx) => (
                    <span key={idx} className="bg-red-50 text-red-700 px-2.5 py-1 rounded-md text-xs font-semibold border border-red-100">
                      {allergy}
                    </span>
                  ))}
                </div>
    ...
    <div className="flex justify-center pt-4 pb-8">
      <button 
        ...
        className="flex items-center gap-2 px-6 py-3 text-red-600 bg-red-50 hover:bg-red-100 rounded-xl font-semibold transition-colors"
      >
